...
async function readXMLAsync(options) {
    const contents = await fs_extra_1.default.readFile(options.path, { encoding: 'utf8', flag: 'r' });
...
async function getProjectXMLPathAsync(projectDir, { kind = 'values', name }) {
    try {
        const shellPath = path_1.default.join(projectDir, 'android');
        if ((await fs_extra_1.default.stat(shellPath)).isDirectory()) {
            const stylesPath = path_1.default.join(shellPath, `app/src/main/res/${kind}/${name}.xml`);
...
exports.getProjectXMLPathAsync = getProjectXMLPathAsync;
...
function getMainApplication(manifest) {
    var _a, _b, _c;
    return ((_c = (_b = (_a = manifest === null || manifest === void 0 ? void 0 : manifest.manifest) === null || _a === void 0 ? void 0 : _a.application) === null || _b === void 0 ? void 0 : _b.filter((e) => e['$']['android:name'] === '.MainApplication')[0]) !== null && _c !== void 0 ? _c : null);
}
exports.getMainApplication = getMainApplication;
function getMainActivity(manifest) {
    var _a;
    const mainActivity = manifest.manifest.application[0].activity.filter((e) => e['$']['android:name'] === '.MainActivity');
    return (_a = mainActivity[0]) !== null && _a !== void 0 ? _a : null;
}
